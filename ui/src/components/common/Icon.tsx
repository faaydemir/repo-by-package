...
export function SeachMenuIcon({ className = 'h-4 w-4' }: IconProps) {
	return (
		<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" stroke="currentColor">
...
export function AscendingSortIcon({ className = 'h-4 w-4' }: IconProps) {
	return (
...
export function DescendingSortIcon({ className = 'h-4 w-4' }: IconProps) {
	return (
		<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor">
...
export function OpenPageIcon({ className = 'h-4 w-4' }: IconProps) {
	console.log(className);
	return (
		<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#5f6368">
...
export function SearchIcon({ className = 'h-4 w-4' }: IconProps) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 -960 960 960">
